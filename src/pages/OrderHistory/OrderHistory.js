    ...
    return (
        <>
            <div className="flex flex-col h-fit gap-3 justify-around mt-6 mb-6">
                <h1 className="text-[#424242] font-medium text-[22px]">Đơn hàng của tôi</h1>
                {allProduct && allProduct.length > 0 ? (
                    allProduct.map((item, index) => {
                        return (
                            <div key={index} className="flex flex-col gap-3 h-full bg-white px-2 py-2 rounded-lg">
                                    ...
                                    return (
                                        <div key={jindex}>
                                            ...
                                            <div className="flex px-32 gap-3">
                                                <img
                                                    onClick={() =>
                                                        viewDetailProduct(jitem.imageData ? jitem.imageData.id : '#')
                                                    }
                                                ...
                                                <div className="flex items-start justify-between w-full">
                                                    ...
                                                    >
                                                        {jitem.imageData ? jitem.imageData.title : 'Sản phẩm đã bị xóa'}
                                                    </p>
                                                    <span className="">
                                                        <NumericFormat
                                                            className="currency"
                                                            type="text"
                                                            value={jitem.imageData ? jitem.imageData.price : '0'}
                                                            displayType="text"
